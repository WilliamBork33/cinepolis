...
class CarsPage extends Page {
    ...
    //get airportPickup()     { return browser.element('.hpadding20>div.go-right>div.iradio_square-grey'); }
...
/* 
     // De Isaac
        browser.touchAction('#collapse2 > div > div > div.slider-track > div:nth-child(2)', [
            { action: 'longPress', x: 0, y: 0 },
            { action: 'moveTo', x: 30, y: 0 },
            { action: 'release' }
]);
 ...
 */
    ...
    airportPickup(){
        //browser.click('#collapse5 > div > select')
